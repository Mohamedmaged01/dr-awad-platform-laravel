...
| the `staff` middleware. Per-feature access is enforced by EnsureStaff via
| the admin-managed permission matrix (App\Support\Access) — each path maps
| to a dashboard-menu feature, so no per-route role lists are needed here.
*/
