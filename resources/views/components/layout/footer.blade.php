        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-16 h-16 rounded-2xl bg-white/5 ring-1 ring-white/10 flex items-center justify-center flex-shrink-0">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="#" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-medical-blue transition-colors" aria-label="Instagram">
                    ...
                    <a href="#" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-medical-blue transition-colors" aria-label="Twitter">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    <a href="#" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-medical-blue transition-colors" aria-label="YouTube">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:{{ $contact['phone_tel'] }}" class="text-gray-400 hover:text-white transition-colors">{{ $contact['phone_display'] }}</a>
                    </li>
                    <li class="flex items-center gap-3">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:{{ $contact['email'] }}" class="text-gray-400 hover:text-white transition-colors">{{ $contact['email'] }}</a>
                    </li>
                    <li class="flex items-start gap-3">
