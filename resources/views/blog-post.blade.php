    ...
    <section class="pt-36 pb-16 gradient-medical">
        <div class="container-custom text-center text-white max-w-3xl">
            ...
            <div class="flex items-center justify-center gap-6 text-white/80 text-sm">
                ...
                <span class="flex items-center gap-2">@svg('lucide-calendar', 'w-4 h-4') {{ \Carbon\Carbon::parse($article['date'])->locale(app()->getLocale() === 'en' ? 'en' : 'ar_EG')->isoFormat('D/M/YYYY') }}</span>
        ...
        <div class="container-custom">
            <x-ui.card class="max-w-3xl mx-auto">
                <x-ui.card-content class="p-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-500 mb-8">{{ __('fullArticleSoon') }}</p>
