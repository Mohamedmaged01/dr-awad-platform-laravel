        ...
        <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-6" id="invoice-print">
            <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 rounded-xl bg-slate-900 ring-1 ring-gray-700 flex items-center justify-center"><img src="{{ asset('images/brand-logo.png') }}" alt="{{ __('heroTitle') }}" class="w-full h-full object-contain"></div>
                    <div>
